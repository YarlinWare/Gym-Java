<%-- 
    Document   : list_ejercicios
    Created on : 26/10/2019, 02:53:24 PM
    Author     : rapterpakfa
--%>
	  ...
	  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	      <div class="carousel-item active">
	        <img src="img/fitness-3.jpg" class="d-block w-100" alt="...">
	      ...
	      <div class="carousel-item">
	        <img src="img/fitness-1.jpg" class="d-block w-100" alt="...">
	        <div class="carousel-caption d-none d-md-block caroucel-text">
