      ...
      var app = new Vue({
        ...
        data: {
          rutinas:[
              {
                  nombre:'Abdominales ', 
                  descripcion:'Las elevaciones de tronco en el suelo son un ejercicio que trabajan sobre todo los abdominales, principalmente solicita músculos como el recto mayor del abdomen y recto anterior.', 
